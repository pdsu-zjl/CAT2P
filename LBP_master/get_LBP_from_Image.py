...
#     image = r"../LBP_master/camourflage_00012.jpg"
#     # image=cv2.imread("../LBP_master/camourflage_00012.jpg",cv2.IMREAD_COLOR)
#     lbp=LBP()
...
#     cv2.imwrite('../LBP_master/camourflage_000121.jpg',basic_array)

#如果结果大小匹配 那就采用采样来调整大小
